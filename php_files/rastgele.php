...
//	{
		...
		$sorgu="select kullanicilar.adi,kullanicilar.kayit_no,kullanicilar.foto,kullanicilar.eposta,resim_no,asagi,resim_baslik,yukari,resim_adi,resimler.dil from resimler join kullanicilar ON resimler.kullanici=kullanicilar.eposta Where gizlilik=0 ORDER BY RAND() limit 0,1";
