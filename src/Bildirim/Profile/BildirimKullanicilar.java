...
public class BildirimKullanicilar implements Serializable {
    String id, name, lastMessage, timestamp,foto,to_user_id,cinsiyet,email,grup,sahibi;
    int unreadCount;

    public BildirimKullanicilar() {
    }

    public BildirimKullanicilar(String id, String name, String lastMessage, String timestamp, int unreadCount) {
        this.id = id;
        this.name = name;
