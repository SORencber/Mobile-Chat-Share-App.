...
public class TrendKullanicilarAdapter extends RecyclerView.Adapter<TrendKullanicilarAdapter.ViewHolder> {

    private Context mContext;
    private ArrayList<TrendsKullanicilar> chatRoomArrayList;
   ...
   String cinsiyet;
    ...
    public TrendKullanicilarAdapter(Context mContext, ArrayList<TrendsKullanicilar> chatRoomArrayList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.three_en_iyi_kullanicilar, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        TrendsKullanicilar chatRoom = chatRoomArrayList.get(position);
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private TrendKullanicilarAdapter.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final TrendKullanicilarAdapter.ClickListener clickListener) {
