...
public class ProfileResimlerAdapter extends RecyclerView.Adapter<ProfileResimlerAdapter.ViewHolder> {
   ...
   String cinsiyet;
    ...
    public ProfileResimlerAdapter(Context mContext, ArrayList<ProfileResimler> trendsResimlerArrayList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.kullanici_profile_resimler, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ProfileResimler trendsResimler = trendsResimlerArrayList.get(position);
...
*/
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private ProfileResimlerAdapter.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final ProfileResimlerAdapter.ClickListener clickListener) {
