...
public class SallaAdapter extends RecyclerView.Adapter<SallaAdapter.ViewHolder> {
   ...
   String cinsiyet;
    ...
    public SallaAdapter(Context mContext, ArrayList<ChatRoom> chatRoomArrayList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_row_salla_bul, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if(chatRoom.getMesafe().equals("boş")) {
            holder.message.setText(mContext.getResources().getString(R.string.couldnotcalculate));

        }
        else{

            holder.message.setText(chatRoom.getMesafe() + "  km "+ mContext.getResources().getString(R.string.distance));
...
//
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private SallaAdapter.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final SallaAdapter.ClickListener clickListener) {
