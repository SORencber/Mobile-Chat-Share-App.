package com.yavuz.rencber.rencber.Profile;
 ...
 */
public class ProfileResimler implements Serializable {
    private String title, thumbnailUrl,mesaj,username,Eposta,diL,adi,soyadi,timestamp;
    private int year;
    ...
    public ProfileResimler() {
    }

    public ProfileResimler(String name, int resim_no, int asagi, int yukari, String thumbnailUrl, int year,String timestamp, double rating,
