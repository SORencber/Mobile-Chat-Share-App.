package com.yavuz.rencber.rencber.GPS.Trends;
 ...
 */
public class TrendsResimler extends ChatRoom implements Serializable {
    ...
    public TrendsResimler() {
    }

    public TrendsResimler(String name,int resim_no,int asagi,int yukari, String thumbnailUrl, int year, double rating,
