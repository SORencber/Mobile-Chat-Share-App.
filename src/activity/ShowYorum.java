...
public class ShowYorum extends Activity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private static final String TAG = ShowYorum.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_yorum);

       // String Path2font = "DroidNaskh-Regular.ttf";

        listView = (ListView) findViewById(R.id.listyorum);
       // ivResim=(ImageViewTouch) findViewById(R.id.ivResim);
       ...
       // ivReply=(ImageView)findViewById(R.id.ivReply);
        ...
        preferences = PreferenceManager.getDefaultSharedPreferences(ShowYorum.this);//preferences objesi
     ...
     // Toast.makeText(getApplicationContext(),silmek.toString(),Toast.LENGTH_LONG).show();
       ...
       // Picasso.with(this).load(Config.SERVER_IS + "" +resimyol).into(ivResim);
        ...
        adapter2 = new CustomListAdapter2(ShowYorum.this, movieList);
    ...
    public void onClick(View v) {
...

                                          {
                                              ...
                                              public void onClick(View v) {
                                                  if(etMessage.getText().length()>0){
                                                      sendMessage();}else{
                                                      etMessage.setError(getResources().getString(R.string.plsyourcomment));
                                                  }
        ...
        ivZilCal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder=new AlertDialog.Builder(ShowYorum.this);
                // new android.support.v7.app.AlertDialog.Builder(this)
                // builder.setCancelable(false);
                builder.setTitle(getResources().getString(R.string.doyouwanttoopennotification));
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.contains("success_login")){
                            ...
                            Toast.makeText(ShowYorum.this.getApplicationContext(), "Birşeyler Yanlış Gitti", Toast.LENGTH_SHORT).show();
                        }
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ShowYorum.this.getApplicationContext(), "Error while reading data", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
...
// TODO Auto-generated method stub
        ...
        builder.setMessage(getApplicationContext().getResources().getString(R.string.doyouwanttodelete));
        builder.setPositiveButton(getResources().getString(R.string.yes),new DialogInterface.OnClickListener() {

            @Override
            public void onClick(DialogInterface dialog, int which) {
                // TODO Auto-generated method stub
                Toast.makeText(ShowYorum.this, getResources().getString(R.string.deleted), Toast.LENGTH_LONG).show();
    ...
    private void sendMessage() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.contains("success_login")){
                           ...
                           // displayNotificationOne();
                            ...
                            Toast.makeText(ShowYorum.this, "Birşeyler Yanlış Gitti", Toast.LENGTH_SHORT).show();
                        }
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ShowYorum.this, "Error while reading data", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
        ...
        MySingleton.getInstance(ShowYorum.this).addToRequestQueue(stringRequest);
    }
